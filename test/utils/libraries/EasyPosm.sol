...
library EasyPosm {
    ...
    function mint(
        ...
        MintData memory mintData = MintData({
            balance0Before: poolKey.currency0.balanceOf(address(this)),
            balance1Before: poolKey.currency1.balanceOf(address(this)),
        ...
        mintData.params[1] = abi.encode(poolKey.currency0, poolKey.currency1);
        mintData.params[2] = abi.encode(poolKey.currency0, recipient);
        mintData.params[3] = abi.encode(poolKey.currency1, recipient);
        ...
        delta = toBalanceDelta(
            -(mintData.balance0Before - poolKey.currency0.balanceOf(address(this))).toInt128(),
            -(mintData.balance1Before - poolKey.currency1.balanceOf(address(this))).toInt128()
        );
    }
